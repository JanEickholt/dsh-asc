...
export const COMPACTION_PHILOSOPHY = [
  ...
  '- context_status — Context status with compressible ranges. No args = overview + recommendations + recent nodes with seqs.',
  '',
